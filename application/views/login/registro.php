                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-4" id="nombres" name="nombres"
                                                        type="text" placeholder="nombres" autofocus required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-4" id="email" name="email"
                                                        ...
                                                        placeholder="xyz@dominio.com" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-4" id="contra" name="contra"
                                                        type="password" placeholder="*******" required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="small mb-1" for="recontra">Confirmar
                                                        contraseña</label>
                                                    <input class="form-control py-4" id="recontra" name="recontra"
                                                        type="password" placeholder="******" required />
                                                </div>
                                            </div>
                                            <div class="g-recaptcha" id="catpcha"
                                                data-sitekey="6LeP6zQaAAAAAJgJf9BOktbUafwj84fiH5JBHONB"></div>
                                        </div>
                                        <div class="form-group mt-4 mb-0"><a class="btn btn-primary btn-block"
                                                id="btnCrear">Crear</a></div>
                                    </form>
                                </div>
