...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <div class="breadcrumb mb-4">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="limpiar()">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-building"></i> Nuevo editorial</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form id="editorial" method="POST">
    ...
    <script src="<?php echo base_url('dist/js/editorial.js') ?>"></script>
</body>