                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center mt-4">
                                <img class="mb-4 img-error" src="<?php echo base_url('dist/images/404.png') ?>" width="180" height="180" />
                                <p class="lead">URL no especificado en el servidor.</p>
                                <small>Revise la ruta especifica!!</small>
                            </div>
                        </div>
                    </div>
                </div>
